...
type PasswordInputProps = {
    register: UseFormRegister<AuthUser>;
    password: string;
};
...
export default function PasswordInput({
    ...
    return (
        <div>
            ...
            <div>
                <Label htmlFor="input-51">Contraseña</Label>
                <div className="relative mt-1">
                    <Input
                        ...
                        {...register("password", {
                            required:
                                "Las contraseñas no es lo suficientemente fuerte",
                            validate: {
                                length: (value) =>
                                    /.{8,}/.test(value) ||
            ...
            <div
                className="mb-4 mt-3 h-1 w-full overflow-hidden rounded-full bg-gray-200"
                role="progressbar"
            ...
            >
                <div
                    ...
                    style={{ width: `${(strengthScore / 5) * 100}%` }} // Ajustado a 5
                ></div>
            </div>
