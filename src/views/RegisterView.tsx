...
import { AuthUser, CurrencyEnum, LanguageEnum, languageSchema } from "@/types";
...
const initialLang = (() => {
    ...
    const result = languageSchema.safeParse(localLang);
...
export default function RegisterView() {
    ...
    const { mutate, isPending } = useMutation({
        ...
        onSuccess(data, variables) {
            toast.success(data);
            navigate(`/confirm-account/${variables.email}`);
        },
        onError(error) {
    ...
    const handleForm = (formData: AuthUser) => {
        if (!acceptTerms) return setTermsError(true);
        mutate(formData);
    };
                    ...
                    >
                        ...
                        <div className="flex gap-3">
                            <div className="w-full">
                                ...
                                <div className="mt-1">
                                    ...
                                    >
                                        {Object.values(LanguageEnum).map(
                                            (lang) => (
                        ...
                        <div>
                            ...
                            <InputErrorMessage
                                message={
                                    termsError
                                        ? "Es obligatorio aceptar los terminos y condiciones"
                                        : undefined
                                }
                            />
                        </div>
